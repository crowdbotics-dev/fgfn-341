"""
Django settings for fgfn_341 project.
...
WSGI_APPLICATION = 'fgfn_341.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fgfn_341 API",
    "DESCRIPTION": "API documentation for fgfn_341 App",
    "VERSION": "v1",
}
